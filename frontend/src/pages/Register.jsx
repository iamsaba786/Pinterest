...
const Register = () => {
  ...
  const { registerUser, btnLoading, darkMode } = UserData(); // ✅ darkMode added
  ...
  return (
    <div
      className={`
      min-h-screen pt-16 flex items-center justify-center transition-colors duration-300
      ${
        darkMode
          ...
          <div>
            ...
            <input
              ...
              className={`
                ...
                ${name ? "ring-2 ring-offset-0 ring-blue-400/30" : ""}
              `}
              value={name}
    ...
    ${
      btnLoading
        ? "opacity-80 cursor-not-allowed active:translate-y-0 active:shadow-[0_6px_0_#7f1d1d]"
        : ""
    }
  `}
            disabled={btnLoading}
