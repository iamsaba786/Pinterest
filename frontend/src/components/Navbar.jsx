    ...
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-xl shadow-xl border-b transition-all duration-300 ${
        darkMode
          ...
          : "bg-white/95 backdrop-brightness-105 border-gray-100 shadow-white/50"
      }`}
    >
    ...
    darkMode
      ...
      {isAuth && mobileMenuOpen && (
        <motion.div
          ...
          className={`absolute right-4 top-full mt-3 w-64 bg-zinc-900/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-zinc-800/50 py-3 px-2 overflow-hidden z-50 ${
            darkMode
              ? "shadow-black/70 backdrop-brightness-150"
              : "bg-white/95 shadow-white/20 border-gray-100/50"
          }`}
          onClick={() => setMobileMenuOpen(false)}
        >
          <Link
            to="/account"
            className={`flex items-center px-5 py-4 text-base font-semibold rounded-2xl hover:bg-zinc-800/60 transition-all duration-200 w-full ${
              darkMode
                ? "text-zinc-200 hover:text-white"
                : "text-gray-200 hover:bg-gray-50/80"
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center px-5 py-4 text-base font-semibold rounded-2xl w-full text-left transition-all duration-200 hover:bg-zinc-800/60 ${
              darkMode
                ? "text-zinc-200 hover:text-white"
                : "text-gray-200 hover:bg-gray-50/80"
            }`}
          ...
          <button
            ...
            className={`w-full flex items-click px-5 py-4 text-base font-semibold text-rose-600 hover:bg-rose-500/10 rounded-2xl transition-all duration-200 ${
